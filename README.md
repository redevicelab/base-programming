...
>Выведите на экран, Вашу фамилию, имя и отчество, каждое слово с новой строки

>Выведите на экран следующую надпись: «Привет программистам» (двойные кавычки так же вывести на печать).
...
// Вывести на экран следующий текст:  С:\project\test.doc
...
1.	Напишите программу, использующую класс «время». Класс должен иметь методы установки часов, минут, секунд, по отдельности, а так же, функции добавления секунд, минут. Например, если было установлено время 01:10:15 при вызове метода добавления секунд, добавляется 100 секунд, метод автоматически изменяет время на: 01:11:55 и т.п. Так же, класс должен содержать метод вывода на экран текущего времени в 24-х часовом формате ЧЧ:ММ:СС 
